...
class Seed_Products extends \S2\Seed 
{
    public function grow()
    {
        ...
        $product->materials()->attach('1', array('quantity' => '120'));
        $product->materials()->attach('4', array('quantity' => '3'));
        $product->materials()->attach('22', array('quantity' => '3'));
        ...
        $product->materials()->attach('19', array('quantity' => '390'));
        $product->materials()->attach('11', array('quantity' => '3'));
        $product->materials()->attach('20', array('quantity' => '50'));
        $product->materials()->attach('17', array('quantity' => '20'));
        $product->materials()->attach('21', array('quantity' => '25'));
        $product->materials()->attach('12', array('quantity' => '1'));
        $product->materials()->attach('14', array('quantity' => '1'));
        ...
        $product->materials()->attach('1', array('quantity' => '180'));
        $product->materials()->attach('4', array('quantity' => '5'));
        $product->materials()->attach('22', array('quantity' => '5'));
        $product->materials()->attach('3', array('quantity' => '510'));
        $product->materials()->attach('8', array('quantity' => '5'));
        $product->materials()->attach('7', array('quantity' => '90'));
        $product->materials()->attach('2', array('quantity' => '7'));
        $product->materials()->attach('19', array('quantity' => '710'));
        $product->materials()->attach('11', array('quantity' => '5'));
        $product->materials()->attach('20', array('quantity' => '80'));
        $product->materials()->attach('17', array('quantity' => '35'));
        $product->materials()->attach('21', array('quantity' => '40'));
        $product->materials()->attach('13', array('quantity' => '1'));
        $product->materials()->attach('14', array('quantity' => '1'));
