...
<body>
	...
	<div id="footer">
		...
		<div id="featured">
			<ul>
				<li class="first">
					<a href="index.php"><img src="images/fruit-cake.jpg" alt="Image" /></a>
					<h2><a href="index.php">Tips on how to preserve</a></h2>
					<p>Lorem ipsum dolor sit amet, consectetuer adispiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. <a href="index.php" class="readmore">read more</a></p>
				</li>
				<li>
					<a href="index.php"><img src="images/italian.jpg" alt="Image" /></a>
					<h2><a href="index.php">Menu of the day: Italian</a></h2>
					<p>Lorem ipsum dolor sit amet, consectetuer adispiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. <a href="index.php" class="readmore">read more</a></p>
				</li>
				<li>
					<a href="index.php"><img src="images/fruit.jpg" alt="Image" /></a>
					<h2><a href="index.php">Fruit menu for your diet</a></h2>
					<p>Lorem ipsum dolor sit amet, consectetuer adispiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. <a href="index.php" class="readmore">read more</a></p>
				</li>
				<li>
					<a href="index.php"><img src="images/desserts.jpg" alt="Image" /></a>
					<h2><a href="index.php">Desserts for every occassion</a></h2>
					<p>Lorem ipsum dolor sit amet, consectetuer adispiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. <a href="index.php" class="readmore">read more</a></p>
				</li>
			</ul>
		</div>
